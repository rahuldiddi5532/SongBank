      ...
      <li class="list-group-item"
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="col-md-6">
              <a class="btn btn-dark btn-block ml-4" id="btn"
                style="color:black;background:linear-gradient(119deg, #FF3CAC 0%, #8604f9 50%, #0293fa 100%);border:none"
                href="../uploads/<?php echo $s['song_mp3'] ?>" download=<?php echo $s['song_name']; ?>><b>Download
                  Mp3</b></a>
            </div>
          </div>
